...
if (($gateKeeper->isAccessAllowed() && $setUp->getConfig("playmusic") === true) || $setUp->getConfig('share_playmusic') === true) {
    if ($debug_mode === true) {
        ?>
    <script src="abcloud-admin/js/soundmanager/soundmanager2.js?v=2.97"></script>
    <script src="abcloud-admin/js/soundmanager/ AB-inlineplayer.js?v=2.97"></script>
        <?php
    } else {
        ?>
    <script src="abcloud-admin/js/soundmanager/soundmanager2.min.js?v=2.97"></script>
        <?php
    }
}

if ($debug_mode === true) { ?>
    <script type="text/javascript" src="abcloud-admin/js/modernizr.js"></script>    
    <script type="text/javascript" src="abcloud-admin/js/bootbox.js"></script>    
    <script type="text/javascript" src="abcloud-admin/js/app.js?v=<?php echo $ AB_version; ?>"></script>
    <?php
} else { ?>
    <script type="text/javascript" src="abcloud-admin/js/app.min.js?v=<?php echo $ AB_version; ?>"></script>
    <?php
} ?> 
<script type="text/javascript" src="abcloud-admin/js/bootstrap.min.js?v=3.3.7"></script>
<script type="text/javascript">
    // confirm
    bootbox.addLocale(' AB', 
    {
        OK : '<?php echo $setUp->getString("OK"); ?>',
        CANCEL : '<?php echo $setUp->getString("CANCEL"); ?>',
        CONFIRM : '<?php echo $setUp->getString("CONFIRM"); ?>'
    });
    bootbox.setLocale(' AB');
</script>
<?php
if ($gateKeeper->isUserLoggedIn()) : ?>
    <script type="text/javascript" src="abcloud-admin/js/avatars.js?v=<?php echo $ AB_version; ?>"></script>
    <?php
endif;

if ($gateKeeper->isAccessAllowed()) : 
    ?>
    <script type="text/javascript" src="abcloud-admin/js/datatables.min.js?v=1.10.16"></script>
    <?php
    /**
     * Setup Files Table
     */
