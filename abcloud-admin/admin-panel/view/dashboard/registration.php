<?php
/**
 *  AB - ab file manager: admin-panel/view/dashboard/registration.php
 * administration registration block
 *
 * @package ABFileManager
 */
                            ...
                            <div class="col-sm-12">
                                <div class="form-group cooldropgroup">
                                    ...
                                    <div class="input-group btn-group cooldrop">
                                        ...
                                        <option value=" AB_reg_new_folder"><?php echo $setUp->getString("new_username_folder"); ?></option>
                                        <?php
