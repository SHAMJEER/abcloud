...
$stepback = $islogin ? '' : 'abcloud-admin/';
...
<nav class="navbar navbar-inverse<?php echo $navbarclass; ?>">
    <div class="container">
        <div class="navbar-header">
            <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#collapse- AB-menu">
        ...
        <div class="collapse navbar-collapse" id="collapse- AB-menu">
...
if ($gateKeeper->isUserLoggedIn()) {
    ...
    if ($gateKeeper->isSuperAdmin()) { ?>
                <li>
                    <a href="<?php echo $setUp->getConfig("script_url"); ?>abcloud-admin/">
...
if ($gateKeeper->isUserLoggedIn() && $setUp->getConfig("show_usermenu") == true ) { 
    ...
    */
    $customfields = false;
    if (file_exists('abcloud-admin/users/customfields.php')) {
        include 'abcloud-admin/users/customfields.php';
    } ?>
    <script type="text/javascript">
    $(document).ready(function(){
