...
if ($gateKeeper->isAccessAllowed()) {
    ...
    if ($gateKeeper->isAllowed('sendfiles_enable') && $gateKeeper->isAllowed('download_enable')) { ?>
        ...
        if ($setUp->getConfig('clipboard')) { ?>
                                <script type="text/javascript" src="abcloud-admin/js/clipboard.min.js"></script>
                                <script type="text/javascript">
...
<script type="text/javascript">
    ...
    var baselink = "abcloud-admin/ AB-downloader.php?q=";
        <?php
    } ?>
</script>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="modal-title">
                        <div class="input-group">
                            <span class="input-group-btn">
                                <a class=" ABlink btn btn-primary" href="#">
    ...
    if ($setUp->getConfig('playvideo') === true) : 
        ...
        ?>
    <link href="abcloud-admin/js/videojs/video-js.min.css" rel="stylesheet">
    <script src="abcloud-admin/js/videojs/video.min.js?v=7.4.1"></script>
    <script src="abcloud-admin/js/videojs/lang/<?php echo $playerlang; ?>.js"></script>
    <script type="text/javascript">
    ...
    function loadVid(thislink, thislinkencoded, thisname, thisID, ext){
        ...
        $(". ABlink").attr("href", baselink + thislinkencoded);
        <?php 
        if ($setUp->getConfig('direct_links') == true) { ?>
            $(". ABlink").attr('target','_blank');
    ...
    */ 
    ...
    function loadImg(thislink, thislinkencoded, thisname, thisID){
        $(". AB-zoom").html("<i class=\"fa fa-refresh fa-spin\"></i><img class=\"preimg\" src=\" AB-thumb.php?thumb="+ thislink +"&y=1\" \/>");
        $("#zoomview").data('id', thisID);
        $("#zoomview .thumbtitle").val(thisname);
        var firstImg = $('.preimg');
