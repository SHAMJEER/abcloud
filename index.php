<?php
define(' AB_APP', true);
require_once 'abcloud-admin/include/head.php';
?>
<!doctype html>
...
<head>
    ...
    <?php echo $setUp->printIcon("abcloud-admin/_content/uploads/"); ?>
    <meta name="description" content="file manager">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <link rel="stylesheet" href="abcloud-admin/css/bootstrap.min.css">
    <link rel="stylesheet" href="abcloud-admin/ AB-style.css">
    <?php 
    if ($setUp->getConfig("txt_direction") == "RTL") { ?>
        <link rel="stylesheet" href="abcloud-admin/css/bootstrap-rtl.min.css">
        <?php 
    } ?>
    <link rel="stylesheet" href="abcloud-admin/css/font-awesome.min.css">
    <link rel="stylesheet" href="abcloud-admin/_content/skins/<?php echo $setUp->getConfig('skin') ?>">
    <script type="text/javascript" src="abcloud-admin/js/jquery-3.3.1.min.js"></script>
    <!--[if lt IE 9]>
    <script src="abcloud-admin/js/html5.js" type="text/javascript"></script>
    <script src="abcloud-admin/js/respond.min.js" type="text/javascript"></script>
    <![endif]-->
    <?php
    $bodyclass = ' AB-body';
    ...
    <script type="text/javascript">
        var audio_ping = new Audio("abcloud-admin/<?php echo $setUp->getConfig('audio_notification'); ?>");
    </script>
        <?php
    } ?>
</head>
