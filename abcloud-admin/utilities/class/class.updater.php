<?php
    ...
    class Updater
    {
         ...
         */
        public static function updateAvatar($checkname = false, $newname = false, $dir = 'abcloud-admin/')
        {
                ...
                foreach ($utenti as $utente) {
                    if ($utente['key'] === $userdata) {
                        ...
                        if ($defaultfolders) {
                            ...
                            if (in_array(' AB_reg_new_folder', $arrayfolders)) {
                                ...
                                $arrayfolders = array_diff($arrayfolders, array(' AB_reg_new_folder'));
        ...
        public function removeOldReg($newusers, $key, $lifetime)
        {
            foreach ($newusers as $subKey => $subArray) {
                ...
                if ($data <= $lifetime) {
                    ...
                    $this->updateRegistrationFile($newusers, 'abcloud-admin/users/');
                }
            }
            return $newusers;
        }
        ...
        public function updateHtaccess($starting_dir, $direct_links = false)
        {
            ...
            $start_marker = "# begin  AB rules";
            $end_marker   = "# end  AB rules";
