<?php
    ...
    class Logger
    {
         ...
         * @return $message
         */
        public static function log($message, $relpath = 'abcloud-admin/')
        {
            if (SetUp::getConfig('log_file') == true) {
                ...
                if (Utils::isFileWritable($logjson)) {
                    ...
                    Utils::setError('The script does not have permissions to write inside "abcloud-admin/_content/log" folder. check CHMOD');
                    return;
                }
            }
        }
         ...
         * @param boolean $remote true if called inside abcloud-admin
         *
         * @return $message
         */
