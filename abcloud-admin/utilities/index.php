...
if (file_exists('_unsensitive-users.php')) {
    if (count($_USERS) > 1 && version_compare($ AB_version, '2.6.3', '>')) {
...
<body class="skin-<?php print $skin; ?> fixed sidebar-mini admin-body <?php echo $rtlclass; ?>"  data-target="#scrollspy" data-spy="scroll" data-offset="100">
    ...
    <footer class="main-footer">
        <!-- <div class="pull-right">
            <a href="https://filemanager.ab.it/" target="_blank" title="Current version">
                <i class=" ABi  ABi-mark"></i> 
                <small> <?php echo $ AB_version; ?></small>
            </a>
        </div> -->
    ...
    <script type="text/javascript" src="js/avatars.js?v=<?php echo $ AB_version; ?>"></script>
    <script type="text/javascript" src="js/datatables.min.js?v=1.10.16"></script>

    <script src="admin-panel/js/app.min.js?v=<?php echo $ AB_version; ?>"></script>
    ...
    <script type="text/javascript" src="admin-panel/js/admin.<?php echo $debug; ?>js?v=<?php echo $ AB_version; ?>"></script>
