...
<form class="form-inline selectdate adminblock" method="get">
    ...
    <div class="form-group">
        <input readonly name="day" value="<?php echo $day; ?>" type="text" class="form-control input-lg  AB-datepicker" placeholder="<?php echo $setUp->getString("select_date"); ?>" onchange="this.form.submit()">
    </div>
