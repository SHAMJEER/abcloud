...
if ($regactive && $setUp->getConfig("registration_enable") == true) :
    ...
    if (file_exists('abcloud-admin/users/users-new.php')) {
        include 'abcloud-admin/users/users-new.php';
        ...
        if ($newuser !== false) {
            ...
            if ($updater->updateRegistrationFile($newusers, 'abcloud-admin/users/')) {
